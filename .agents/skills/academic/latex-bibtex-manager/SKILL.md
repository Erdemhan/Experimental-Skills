...
description: >
  Activate this skill when creating or editing LaTeX documents (.tex), formatting 
  academic tables, managing BibTeX citations (.bib), or troubleshooting LaTeX 
  compilation errors (pdflatex/latexmk). Supports NeurIPS, ICML, ICLR, IEEE, and ACM formats.
---
