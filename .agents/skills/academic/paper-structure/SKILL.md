...
description: >
  Activate this skill when writing an academic paper, conference submission, journal 
  article, thesis chapter, or any formal academic document. This skill enforces the 
  IMRaD structure (Introduction, Methods, Results, and Discussion), section-specific 
  writing standards, and transition logic between sections.
---
