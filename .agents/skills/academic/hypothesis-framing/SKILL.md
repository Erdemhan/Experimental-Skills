...
description: >
  Activate this skill when formulating research questions, defining hypotheses, 
  designing study objectives, or creating an experimental framework. This skill 
  ensures hypotheses are specific, measurable, falsifiable, and properly structured 
  with null and alternative forms.
---
