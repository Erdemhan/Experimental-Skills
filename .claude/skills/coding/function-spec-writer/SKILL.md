...
description: >
  Activate this skill when designing a function before implementation. This skill 
  produces a complete FunctionSpec with type-annotated signature, Google-style 
  docstring, pre/post conditions, edge cases, and concrete test cases. Use this 
  before giving any function to a coder agent or writing code directly.
---
