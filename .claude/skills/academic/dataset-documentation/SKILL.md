...
description: >
  Activate this skill when using, creating, or describing a dataset in any academic 
  or technical context. This skill enforces documentation of data provenance, license, 
  statistics, preprocessing steps, and potential limitations — following the Datasheet 
  for Datasets standard.
---
